		...
		$.ajax({
			...
			success: function(data){
				...
				$.each(connectors, function(i, v){
					...
					output += "<td>" + v["host"] + "</td>";
					output += "<td>" + v["port"] + "</td>";
					output += '<td class="text-center">' + (v["session"] === "BOUND_TRX" || v["session"] === "BOUND_TX" || v["session"] === "BOUND_RX" ? '<i class="fa fa-circle fa-lg text-success"><i/>':'<i class="fa fa-circle fa-lg text-warning"><i/>') + "</td>";
